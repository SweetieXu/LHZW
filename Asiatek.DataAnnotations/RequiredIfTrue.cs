...
{
    /// <summary>
    /// 指定当依赖的属性值为True时需要数据字段值
    /// 作者：戴天辰
    /// </summary>
    [AttributeUsage(AttributeTargets.Property, AllowMultiple = false)]
    public class RequiredIfTrueAttribute : RequiredAttribute, IClientValidatable
    {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (dependentvalue.Equals(true))//如果依赖的值等于True，那么就需要验证当前属性的有效性
            {
