<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptForm3.aspx.cs" Inherits="Asiatek.TMS.ReportFiles.reports.RptForm3" %>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td>&nbsp;&nbsp;&nbsp;</td>
                    <td>
                        <label><%=Asiatek.Resource.DisplayText.DealUser %>：</label>
                    </td>
                    <td>
                        <input id="txtDealUser" type="text" name="txtDealUser" value="" class="form-control" placeholder="<%=Asiatek.Resource.UIText.PleaseInput + Asiatek.Resource.DisplayText.NickName+Asiatek.Resource.UIText.Or+Asiatek.Resource.DisplayText.UserName%>" />
                        <asp:HiddenField ID="hidDealUser" runat="server" Value="" ClientIDMode="Static" />
                    </td>
                    <td>&nbsp;&nbsp;&nbsp;</td>
                    <td>
