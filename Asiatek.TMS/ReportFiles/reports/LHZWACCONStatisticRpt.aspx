<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LHZWACCONStatisticRpt.aspx.cs" Inherits="Asiatek.TMS.ReportFiles.reports.LHZWACCONStatisticRpt" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        var checkDateRange = function () {
            ...
            if (_startTime.getMonth() != _endTime.getMonth())
            {
                var _title = '<%=Asiatek.Resource.UIText.InformationTitle%>';
                var _close = '<%=Asiatek.Resource.UIText.Close%>';
                $.showPromptDialog('时间不可以跨月', _title, _close);
                return false;
            }
            ...
            if (dates >= 7) {
                var _title = '<%=Asiatek.Resource.UIText.InformationTitle%>';
                var _close = '<%=Asiatek.Resource.UIText.Close%>';
                $.showPromptDialog('时间跨度不可以超过七天', _title, _close);
                return false;
            }
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:HiddenField ID="hidVIN" runat="server" Value="" ClientIDMode="Static" />
                    </td>
                    <td>&nbsp;&nbsp;&nbsp;</td>
                    <td>
