<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VehicleOffLineRpt.aspx.cs" Inherits="Asiatek.TMS.ReportFiles.reports.VehicleOffLineRpt" %>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" id="txtStartTime" name="txtStartTime" value="<%=this.StartTime %>" class="form-control" placeholder="<%=Asiatek.Resource.DisplayText.StartTime%>" readonly="readonly" disabled="disabled"/>
