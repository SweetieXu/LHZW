...
{
    public class EmergencyAlarmSeachModel : ContainsPagedDatas<EmergencyAlarmListModel>
    {
        ...
        /// 处理人
        /// </summary>
        [Display(Name = "DealUser", ResourceType = typeof(DisplayText))]
    ...
    public class EmergencyAlarmListModel
    {
        public long ID { get; set; }
        ...
        /// 处理时间
        /// </summary>
        [Display(Name = "DealTime", ResourceType = typeof(DisplayText))]
        public string DealTime { get; set; }

        /// <summary>
        /// 处理信息
        /// </summary>
        [Display(Name = "DealInfo", ResourceType = typeof(DisplayText))]
